...
const int l298n_In1 = 19; // 4 in control module L298N
const int l298n_In2 = 18;
const int l298n_In3 = 17;
const int l298n_In4 = 16;

LiquidCrystal_I2C lcd(0x27, 16, 2);

// Assign output variables to GPIO pins button ??
//const int pin_Control_Close = 2;
//const int pin_Control_Open = 4;
